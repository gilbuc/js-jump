...
Hero.prototype.move = function (direction) {
    ...
    // if hero goes left, look left (scale -100%)
...
PlayState._handleCollisions = function () {
    ...
    this.game.physics.arcade.overlap(this.hero, this.door, this._onHeroVsDoor, this._filterIgnoreKeyOrPlayOnAir, this);
}
...
PlayState._filterIgnoreKeyOrPlayOnAir = function (hero, door){
